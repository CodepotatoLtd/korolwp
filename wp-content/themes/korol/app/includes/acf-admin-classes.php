...
function my_acf_admin_head()
{
    ...
    <style type="text/css">
        ...
        .theme-repeater > .acf-label {
            display: none;

        }

        .theme-repeater > .acf-input {
            float: left;
            width: 100% !important;
            margin: 0;
            padding: 0 12px;
        ...
        .theme-repeater .acf-repeater.-block>table, .acf-repeater.-row>table {
