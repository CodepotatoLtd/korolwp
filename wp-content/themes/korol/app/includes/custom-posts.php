...
add_action('init', 'register_casetudies_post_type');

function register_casetudies_post_type()
{
    $labels = array(
        'name'               => _x('Casestudies', 'post type general name', 'theme'),
        'singular_name'      => _x('Casestudy', 'post type singular name', 'theme'),
        'menu_name'          => _x('Casestudies', 'admin menu', 'theme'),
        'name_admin_bar'     => _x('Casestudies', 'add new on admin bar', 'theme'),
        'add_new'            => _x('Add New', 'Testimonial', 'theme'),
        'add_new_item'       => __('Add New', 'theme'),
        'new_item'           => __('New', 'theme'),
        'edit_item'          => __('Edit', 'theme'),
...
{
    $labels = array(
        'name'               => _x('Team', 'post type general name', 'theme'),
        'singular_name'      => _x('Team', 'post type singular name', 'theme'),
        'menu_name'          => _x('Team', 'admin menu', 'theme'),
        'name_admin_bar'     => _x('Team', 'add new on admin bar', 'theme'),
        'add_new'            => _x('Add New', 'Testimonial', 'theme'),
        'add_new_item'       => __('Add New', 'theme'),
        'new_item'           => __('New', 'theme'),
        'edit_item'          => __('Edit', 'theme'),
