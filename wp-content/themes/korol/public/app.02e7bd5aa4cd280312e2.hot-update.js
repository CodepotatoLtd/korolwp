  ...
  constructor() {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('#timeline-wrapper').length) {
      ...
      function setTriggers() {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.year').each(function (index) {
          gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.create({
            trigger: this //         //invalidateOnRefresh: true,
            //         //pin: true,
            //         //scrub: 3,
            //         markers: true,
            //         //end: () => "+=" + (4 * container.offsetWidth),
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "44cb9242a6b8f07d4495"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=app.02e7bd5aa4cd280312e2.hot-update.js.map