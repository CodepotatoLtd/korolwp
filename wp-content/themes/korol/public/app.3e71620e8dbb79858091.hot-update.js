  ...
  constructor() {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('#timeline-wrapper').length) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.year').each(function (index) {
        ...
        let hasTriggerID = "#trigger" + index;
        let triggerElement = "<div class='trigger'></div>";
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "8012ea4e047d808af1ef"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=app.3e71620e8dbb79858091.hot-update.js.map