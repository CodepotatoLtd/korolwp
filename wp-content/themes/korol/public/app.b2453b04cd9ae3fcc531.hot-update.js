  ...
  constructor() {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('#timeline-wrapper').length) {
      ...
      function setTriggers() {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set("trigger-last", {
          top: 4 * container.offsetWidth
        });
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.year').each(function (index) {
          ...
          let triggerElement = "<div id=" + triggerID + " class='trigger'></div>"; //$("#timeline-wrapper").append(triggerElement);
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "2a3835928522e592606e"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=app.b2453b04cd9ae3fcc531.hot-update.js.map