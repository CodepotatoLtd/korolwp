  ...
  constructor() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(swiperClass).each(function (index) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(".before-after-image-wrapper").each(function (index) {
        $before = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".before", this);
        $after = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".after", this);
        $switcher = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".switcher-btn", this);
      });
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "3ef565562b48b53f547c"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=app.d23e43d6d810aa7f6a59.hot-update.js.map