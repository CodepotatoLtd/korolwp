      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.member').each(function (index) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.show-bio', $member).click(function () {
          if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.bio', $member).hasClass('visible')) {
            ...
            gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(jquery__WEBPACK_IMPORTED_MODULE_0___default()('.bio', $member), 0.4, {
              height: 'auto',
              ease: Power4.easeOut
            });
          } else {
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "3048e8fc523b071026f2"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=app.70b136407e0e5707af84.hot-update.js.map