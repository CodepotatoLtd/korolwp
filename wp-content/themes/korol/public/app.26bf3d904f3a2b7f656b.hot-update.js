  ...
  constructor() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(swiperClass).each(function (index) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(".before-after-image-wrapper").each(function (index) {
        ...
        this.switchBtns = this.container.getElementsByClassName("img-switcher");
        this.imgContainers = this.container.getElementsByClassName("img-container");

        for (let i = 0; i < this.switchBtns.length; i++) {
          const id = i;
          this.switchBtns[i].addEventListener("click", evt => {
            const e = evt;
            this.clickSwitcher(e);
          });
        }

        function clickSwitcher(evt) {
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "e575f1ecb1f21629d5d2"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=app.26bf3d904f3a2b7f656b.hot-update.js.map