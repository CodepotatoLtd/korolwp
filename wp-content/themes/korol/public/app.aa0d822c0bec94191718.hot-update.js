  ...
  constructor() {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('#timeline-wrapper').length) {
      ...
      function setTriggers() {
        let numberOfYears = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#timeline-wrapper .year').length + 1;
        let containerHeight = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#timeline-wrapper').height(); //let totalDivisions = 3 + numberOfYears

        let divisionHeight = containerHeight / numberOfYears;
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.year').each(function (index) {
          ...
          let triggerOffset = divisionHeight + index * divisionHeight;
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "27425320dd655aa51cfa"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=app.aa0d822c0bec94191718.hot-update.js.map