  ...
  constructor() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(swiperClass).each(function (index) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(".before-after-image-wrapper").each(function (index) {
        ...
        let $switcher = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".switcher-btn", this); //const container = document.getElementsByClassName("gallery-before-after-coverflow-swiper");

        let switchBtns = document.getElementsByClassName("img-switcher"); // this.imgContainers =
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "4651d484407331000947"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=app.709e7f270592981e7380.hot-update.js.map