  ...
  constructor() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(swiperClass).each(function (index) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(".before-after-image-wrapper").each(function (index) {
        ...
        let $switcher = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".switcher-btn", this); //gsap.set($switcher.parent(), { opacity: 0.1 });

        jquery__WEBPACK_IMPORTED_MODULE_1___default()(".switcher-btn").on("click", function () {
          alert("Handler for `click` called.");
        });
        jquery__WEBPACK_IMPORTED_MODULE_1___default()(selector).on("mouseenter", handlerIn).on("mouseleave", handlerOut);
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "0a2a7c8ba40e9dbfed66"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=app.366e99fd5f18efa3225f.hot-update.js.map