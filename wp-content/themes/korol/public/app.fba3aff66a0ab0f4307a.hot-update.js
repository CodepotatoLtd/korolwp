...
class Timeline {
  constructor() {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('#timeline-wrapper').length) {
      ...
      let totalDivisions = 3 + length + 2;
      let divisionHeight = containerHeight / totalDivisions;
      const myTimeout = setTimeout(myGreeting, 500);

      function myGreeting() {
        let h = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#timeline-wrapper').height();
        alert(h);
      }
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.year').each(function (index) {
        ...
        let triggerOffset = 3 * divisionHeight + index * divisionHeight;
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "4a1e5efdf8ee890712aa"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=app.fba3aff66a0ab0f4307a.hot-update.js.map