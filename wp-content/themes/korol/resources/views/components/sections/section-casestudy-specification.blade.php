  ...
  while (have_rows('stats')):
    the_row(); ?>
                    ...
                    <div class="col-6 col-lg-3">
                        <div id="s<?php    echo $count;?>"
                            class="spec-wrapper p-t-mobile-intro p-b-mobile-intro p-t-desktop-intro p-b-desktop-intro"
                            data-aos="fade-up" data-aos-duration="750" data-aos-delay="<?php    echo $delay;?>">
