            ...
            <div class="key text-dark">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div>
                                {{-- <div class="corporate-key p-b-mobile-element p-b-desktop-element">Corporate time
                                </div>--}}
                                {{-- <div class="project-key p-t-mobile-element p-t-desktop-element">Project timeline
                                </div>--}}
                            </div>
                        </div>
                    </div>
                ...
                <div class="content">
                    ...
                    <span class="dot">
                        ...
                        <svg class="d2" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="50" cy="50" r="35" vector-effect="non-scaling-stroke" stroke-linecap="round"
                                fill="#EEEDEB" stroke="none" stroke-width="0" />
                        </svg>
                    </span>
